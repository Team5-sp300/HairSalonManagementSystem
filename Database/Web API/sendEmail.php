								...
								<table align="left" class="column" style="width: 250px; min-width: 279px; float:left;">
									<tr style="padding: 15px;">
										<td>
											...
											<h5 class="" style="font-weight:500; font-size: 17px; line-height: 1.1; margin-bottom:15px; margin-left:15px; color:#000"><b>Contact Info:</b></h5>
											<p style="font-size:15px; font-family: Arial; margin-bottom: 10px;	font-weight: normal; line-height:1.6;margin-left:15px; ">Phone: +27 85 783 1922<br />
