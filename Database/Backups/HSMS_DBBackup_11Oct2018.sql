...
(4,1,'AndSch676','2018-10-11 00:00:00','08:00',1),
(5,1,'AndSch676','2018-10-30 00:00:00','08:00',1);
...
('AndSch676','Andrew','Schwabe','123','0000','swabe@live.co.za','Active',1),
('EriOdd357','Eric','Odding','123','0002','eodding@test.com','Active',1),
('JPDeJ874','JP','DeJager','123','0003','jpdejager@test.com','Active',1),
('NicCla309','Nick','Claassens','123','0001','nclassens@test.com','Active',1);
...
BEGIN
	SELECT(SELECT EmployeeFname FROM Employee WHERE Booking.EmployeeUsername=Employee.Username),DATE_FORMAT(AppointmentDate,"%d/%m"),
...
BEGIN
	SELECT(SELECT CustomerName FROM Customer WHERE Booking.CustomerID=Customer.CustomerID),DATE_FORMAT(AppointmentDate,"%d/%m"), AppointmentTime, 
...
-- Dump completed on 2018-10-11 22:40:29
-- Total time: 0:0:0:0:137 (d:h:m:s:ms)
